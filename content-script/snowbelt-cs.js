...
window.onload = function () {
    let el = document.querySelector("now-message");
    console.log(el);
    if (el === undefined || !el || el.getAttribute("key") === undefined) {
        console.log("*SNOW TOOL BELT* Not a Service Now instance, stopping now");
        return;
    }
